     ...
     <Layout>
       ...
       <div className="absolute left-10 top-1/2 z-10">
        ...
        <div className="flex relative space-x-4">
            ...
            className="border-4 border-black p-10 h-40 drop-shadow-md  flex flex-col justify-center font-bold text-4xl rounded-2xl"
        ...
        <div className="absolute top-1/2  right-0 transform -translate-y-1/2">
            <div className="border-4 border-black p-6 font-bold tracking-widest flex flex-col items-center text-4xl leading-15">
